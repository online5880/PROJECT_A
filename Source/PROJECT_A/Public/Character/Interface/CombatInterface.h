...
public:
	 ...
	 * @param PushValue 밀리는 수치
	 * @param DamageCauser 데미지를 주는 액터
	 * @param CameraShakeBase CameraShake Class
	 */
	virtual void TakeDamage(const float Damage, const FVector& Normal,FHitResult const& HitInfo,const float PushValue,AActor* DamageCauser,TSubclassOf<UCameraShakeBase> CameraShakeBase = nullptr) = 0;
